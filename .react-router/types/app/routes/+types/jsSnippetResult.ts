...
// routes/jsSnippetResult.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../jsSnippetResult.js")

export type Info = {
  parents: [Parent0],
  id: "routes/jsSnippetResult"
  file: "routes/jsSnippetResult.tsx"
  path: "/view-snippet/:snippetId"
  params: {"snippetId": string} & { [key: string]: string | undefined }
  module: Module
